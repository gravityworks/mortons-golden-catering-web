    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="container-custom">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6 text-gray-300">
                <p>
                  At Morton's Fine Catering, we understand that successful business events require 
                  meticulous planning, reliable execution, and exceptional food. Our corporate 
                  catering services are designed to meet the unique needs of businesses throughout 
                  the Greater Lansing area.
                </p>
                <p>
                  Whether you're hosting a morning meeting, a multi-day conference, a product launch, 
                  or your annual holiday party, our team delivers a seamless catering experience 
                  that allows you to focus on your business objectives while we handle the details.
                </p>
                <p>
        ...
        <FoodGallery 
          ...
          title="Corporate Catering Gallery"
          subtitle="Examples of our corporate catering services across Greater Lansing"
        ...
        <Testimonials 
          ...
          subtitle="What our corporate clients say about our catering services"
