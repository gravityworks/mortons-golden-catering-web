...
const Hero = ({
  ...
  return <div className={`relative ${height} w-full flex items-center justify-center`}>
      {/* Background Image */}
      ...
      <div className="relative z-10 text-center px-8">
        ...
        {description && <p className="text-white/90 text-lg md:text-xl max-w-2xl mx-auto mb-8 leading-relaxed">
            {description}
          </p>}
        {ctaText && <Link to={ctaLink} className="btn-gold inline-block">
            {ctaText}
          </Link>}
      </div>
    </div>;
